  ...
  "NotebookApp": {
    ...
    def getInstanceId(self, value):
        ...
        while (status['Reservations'][0]['Instances'][0]['State']['Name'] == 'pending'):
            ...
            status = client.describe_instances(Filters=Filters)
        time.sleep(5)
        return status['Reservations'][0]['Instances'][0]['PublicDnsName']
    ...
    def create_ec2(self):
        ...
        while (status['Reservations'][0]['Instances'][0]['State']['Name'] == 'pending'):
            ...
            status = client.describe_instances(Filters=Filters)
        time.sleep(5)
        with open('/Users/srramas/.instanceid', 'w') as filetowrite:
            filetowrite.write(status['Reservations'][0]['Instances'][0]['PublicDnsName'])
